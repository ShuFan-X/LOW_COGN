...
Height = st.number_input("Height(cm)", min_value=0.0, max_value=250.0, value=1, step=0.1)
Weight = st.number_input("Weight(kg)", min_value=0.0, max_value=150.0, value=1, step=0.1)
...
PIR = st.number_input("PIR", min_value=0.0, max_value=10.0, value=1, step=0.1)
...
TC = st.number_input("Total cholesterol(mg/dL)", min_value=0.00, max_value=2000.00, value=1, step=0.01)
TG = st.number_input("Triglycerides(mg/dL)", min_value=0.00, max_value=2000.00, value=1, step=0.01)
HDL = st.number_input("HDL(mg/dL)", min_value=0.00, max_value=2000.00, value=1, step=0.01)
LDL = st.number_input("LDL(mg/dL)", min_value=0.00, max_value=2000.00, value=1, step=0.01)
PLT = st.number_input("PLT(1000cells/uL)", min_value=0.00, max_value=2000.00, value=1, step=0.01)
CR = st.number_input("CR(mg/dL)", min_value=0.00, max_value=100.00, value=1, step=0.01)
