...
Height = st.number_input("Height(cm)", min_value=0, max_value=250, value=0.1)
Weight = st.number_input("Weight(kg)", min_value=0, max_value=150, value=0.1)
...
TC = st.number_input("Total cholesterol(mg/dL)", min_value=0, max_value=2000, value=0.01)
TG = st.number_input("Triglycerides(mg/dL)", min_value=0, max_value=2000, value=0.01)
HDL = st.number_input("HDL(mg/dL)", min_value=0, max_value=2000, value=0.01)
LDL = st.number_input("LDL(mg/dL)", min_value=0, max_value=2000, value=0.01)
PLT = st.number_input("PLT(1000cells/uL)", min_value=0, max_value=2000, value=1)
CR = st.number_input("CR(mg/dL)", min_value=0, max_value=100, value=0.01)
